-- Anime Expeditions dashboard: track equipment (data.EquipmentData) alongside
-- units/inventory on the heavy account_details table, same pattern as both.

alter table public.account_details add column if not exists equipment jsonb not null default '[]'::jsonb;
